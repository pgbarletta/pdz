...
for paso = 1:2000
    ...
    writetable(string(home, neq, "2pca/wcorta/", "weights_a_neq_step", paso), df_weights_t0a, separator = '\t')
    writetable(string(home, neq, "2pca/wcorta/", "weights_b_neq_step", paso), df_weights_t0b, separator = '\t')

    writetable(string(home, neq, "2pca/wcorta/", "pnum_neq_step", paso), df_pnum_cnt_a, separator = '\t')
