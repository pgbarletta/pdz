...
for paso = 1:180
    ...
    writetable(string(home, neq, "pca/wlarga/", "weights_a_neq_step", paso), df_weights_t0a, separator = '\t')
    writetable(string(home, neq, "pca/wlarga/", "weights_b_neq_step", paso), df_weights_t0b, separator = '\t')

    writetable(string(home, neq, "pca/wlarga/", "pnum_neq_step", paso), df_pnum_cnt_a, separator = '\t')
