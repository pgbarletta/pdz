...
#    in_avg_filename = string(home, neq, "pca/larga/", "avg_step_", paso, "plb_4.pdb")
    ...
    writetable(string(home, neq, "bu2pca/wlarga/", "weights_a_neq_step", paso), df_weights_t0a, separator = '\t')
    writetable(string(home, neq, "bu2pca/wlarga/", "weights_b_neq_step", paso), df_weights_t0b, separator = '\t')

    writetable(string(home, neq, "bu2pca/wlarga/", "pnum_neq_step", paso), df_pnum_cnt_a, separator = '\t')
