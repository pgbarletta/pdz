#!/bin/bash
#PBS -N temp_corta_lig
#PBS -o temp_corta_lig.out
...
do
	...
	archivo="$i"lig_corta_temp_cpp_in
	salida="$i"lig_salida
	...
	echo "temperature T1 :125-132 ntc 1 out /scratch/pbarletta/pdz/run/lb/neq/temperatura/lig/"$i"corta_temp_lig" >> $archivo
	echo "go" >> $archivo
