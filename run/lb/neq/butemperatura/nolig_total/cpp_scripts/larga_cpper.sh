#!/bin/bash
#PBS -N temp_larga_total
#PBS -o temp_larga_total.out
...
do
	...
	echo "temperature T1 :1-124 ntc 1 out /scratch/pbarletta/pdz/run/lb/neq/temperatura/nolig_total/larga/"$i"larga_temp_total" >> $archivo
	echo "go" >> $archivo
